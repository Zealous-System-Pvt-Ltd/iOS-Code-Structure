...
extension UIAlertController {
    ...
    public func show(selectedVC:UIViewController = UIApplication.shared.keyWindow?.rootViewController ?? UIViewController(),animated: Bool = true, vibrate: Bool = false, style: UIBlurEffect.Style? = nil, completion: (() -> Void)? = nil) {
        ...
        DispatchQueue.main.async {
            selectedVC.present(self, animated: animated, completion: completion)
            if vibrate {
