...
class CustomTextField: UITextField {
    ...
    @IBInspectable open var leftpading :Int = 0
        {
        didSet {
            self.leftPaddingByvalue(leftpading)
        }
    }
    ...
    fileprivate func leftPaddingByvalue(_ pading :Int) {
        let paddingLeft = UIView(frame: CGRect(x: 0, y: pading, width: 5, height: 5))
        self.leftView = paddingLeft
        self.leftViewMode = UITextField.ViewMode.always
        ...
        let view = UIView(frame: CGRect(x: 0, y: 0, width:pading, height:45))
        //        view.addSubview(imageView)
        self.leftView = view
    }
